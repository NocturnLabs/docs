...
> [!NOTE]
> This tool is part of the **YumLabs Tools** suite and is designed to work seamlessly with the OpenCode CLI.
...
```bash
git clone https://github.com/yumlabs-tools/opencode-autocode.git
...
Pre-compiled binaries are available for Linux, macOS, and Windows on the [Releases](https://github.com/yumlabs-tools/opencode-autocode/releases) page.
